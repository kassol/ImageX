...
public:
	HRESULT SetRange(double LBX,double LBY,double RTX,double RTY,double CellSize);
	HRESULT SetCellSize(double CellSize);
	HRESULT SetFlatAltitude(double Z);
	HRESULT CreateFlatDEM(int nRows, int nCols, double LBX, double LBY, double Altitude, double CellSize);
